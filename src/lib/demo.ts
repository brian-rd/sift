...
export const demoFiles: DownloadFile[] = [
  ...
  { path: 'C:\\Users\\you\\Downloads\\meeting-notes.md', name: 'meeting-notes.md', extension: 'md', size: 18_600, modifiedAt: now - 12 * 86_400_000, createdAt: now - 12 * 86_400_000, kind: 'text', suggestedFolders: ['Documents / Notes'] },
  { path: 'C:\\Users\\you\\Downloads\\screen-recording.mov', name: 'screen-recording.mov', extension: 'mov', size: 684_000_000, modifiedAt: now - 34 * 86_400_000, createdAt: now - 34 * 86_400_000, kind: 'video', suggestedFolders: ['Videos / Recordings'], previewUrl: 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4' },
