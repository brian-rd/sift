...
<aside class:compact aria-label="Main navigation">
  ...
  <div class="sidebar-bottom">
    <button class="folder-card" on:click={onWatchedFolder} title="Change watched folder">
      <FolderOpen size={17} />
      <div><strong>Downloads</strong><span>{watchEnabled ? 'Watching now' : 'Manual scans'}</span></div>
      <span class:paused={!watchEnabled} class="status-dot" title={watchEnabled ? 'Watching' : 'Watching paused'}></span>
    </button>
...
<style>
  aside{width:236px;min-width:236px;height:100vh;padding:24px 14px 18px;background:#ecebe6;border-right:1px solid var(--border);display:flex;flex-direction:column;position:sticky;top:0}.brand{display:flex;align-items:center;gap:11px;padding:0 8px 28px}.brand-mark{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;color:#fff;background:var(--ink)}.brand-name{font-family:var(--font-display);font-size:22px;font-weight:650;letter-spacing:-.02em}nav{display:flex;flex-direction:column;gap:4px}nav button,.settings-button{width:100%;height:42px;display:flex;align-items:center;gap:11px;padding:0 11px;border:0;border-radius:9px;color:var(--text-2);background:transparent;font:inherit;font-weight:550;cursor:pointer;transition:background .16s,color .16s}nav button:hover,.settings-button:hover{background:rgba(255,255,255,.65);color:var(--ink)}nav button.active,.settings-button.active{background:#fff;color:var(--ink);box-shadow:0 1px 2px rgba(28,28,25,.06)}nav button .count{margin-left:auto;min-width:22px;padding:2px 7px;border-radius:999px;background:var(--ink);color:white;font-size:11px;text-align:center}.mobile-settings{display:none}.sidebar-bottom{margin-top:auto;display:flex;flex-direction:column;gap:5px}.folder-card{display:flex;align-items:center;gap:10px;padding:12px;border-radius:10px;background:rgba(255,255,255,.55);border:1px solid rgba(34,34,30,.07)}.folder-card div{display:flex;flex-direction:column;min-width:0}.folder-card strong{font-size:12px}.folder-card span{font-size:10px;color:var(--text-3)}.folder-card .status-dot{width:7px;height:7px;border-radius:50%;background:var(--green);margin-left:auto}.folder-card .status-dot.paused{background:var(--text-3)}.settings-button{margin-top:2px}@media(max-width:820px){aside{width:72px;min-width:72px;padding-inline:10px}.brand-name,nav button>span,.folder-card div,.settings-button span{display:none}.brand{padding-inline:9px}.brand-mark{width:34px}.folder-card{justify-content:center;padding:12px 8px}.folder-card .status-dot{position:absolute;margin:22px 0 0 22px}nav button,.settings-button{justify-content:center;padding:0}.compact{width:72px;min-width:72px}}@media(max-width:560px){aside{position:fixed;bottom:0;top:auto;left:0;width:100%;height:64px;z-index:50;padding:7px 10px;border-right:0;border-top:1px solid var(--border)}.brand,.sidebar-bottom{display:none}.mobile-settings{display:flex}nav{flex-direction:row;justify-content:space-around}nav button{width:54px;height:48px;flex-direction:column;gap:2px;font-size:9px}nav button>span{display:block}nav button .count{position:absolute;margin:-22px 0 0 27px;padding:1px 5px;min-width:17px}}
