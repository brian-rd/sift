...
<aside class:compact aria-label="Main navigation">
  ...
  <div class="sidebar-bottom">
    <Tooltip
      text={watchEnabled
        ? 'Change watched folder · Watching for new files'
        : 'Change watched folder · Automatic watching paused'}
      placement="right"
      block
    >
...
<style>
  ...
  .settings-button.active {
    ...
    color: var(--ink);
    box-shadow: 0 1px 2px rgba(13, 20, 17, 0.08);
  }
  nav button .count {
    margin-left: auto;
    min-width: 22px;
  ...
  .folder-card:focus-visible {
    outline: none;
    box-shadow: inset 0 0 0 2px var(--accent-pressed);
  }
</style>
