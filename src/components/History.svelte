...
<style>
  .history-toolbar{height:56px;display:flex;align-items:center;justify-content:space-between;padding:0 14px;margin-bottom:22px;background:var(--surface);border:1px solid var(--border);border-radius:11px}.history-toolbar label{width:260px;height:34px;display:flex;align-items:center;gap:8px;padding:0 10px;background:var(--surface-2);border:1px solid transparent;border-radius:7px;color:var(--text-3)}.history-toolbar label:focus-within{border-color:var(--accent)}.history-toolbar input{width:100%;border:0;outline:0;background:transparent!important;color:var(--ink);font:11px var(--font-ui)}.history-toolbar input::placeholder{color:var(--text-3)}.history-toolbar>span{display:flex;align-items:center;gap:6px;color:var(--success-text);font-size:9px}.session{margin-bottom:25px}.session>header{display:flex;align-items:end;justify-content:space-between;margin-bottom:9px;padding:0 2px}.eyebrow{font-size:8px;text-transform:uppercase;letter-spacing:.12em;font-weight:750;color:var(--text-3);margin:0 0 3px}.session h2{font:650 16px var(--font-display);margin:0}.session>header button{display:flex;align-items:center;gap:6px;border:0;background:transparent;color:var(--text-2);font:600 9px var(--font-ui);cursor:pointer}.session>header button:disabled{opacity:.35}.history-list{border:1px solid var(--border);border-radius:11px;background:var(--surface);overflow:hidden}.history-list article{display:grid;grid-template-columns:40px minmax(180px,1.5fr) minmax(150px,1fr) 76px;gap:12px;align-items:center;min-height:65px;padding:8px 14px;border-top:1px solid var(--border)}.history-list article:first-child{border:0}.action-icon{width:36px;height:36px;border-radius:9px;display:grid;place-items:center;background:var(--success-bg);color:var(--success-text)}.action-icon.trash{background:var(--danger-bg);color:var(--danger-text)}.file,.result{display:flex;flex-direction:column;min-width:0}.file strong,.result strong{font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.file span,.result span{font-size:9px;color:var(--text-3);margin-top:3px}.result strong{margin-top:3px;color:var(--text-2)}.undo{height:29px;display:flex;align-items:center;justify-content:center;gap:5px;border:1px solid var(--border);border-radius:7px;background:var(--surface-2);color:var(--text-2);font:600 9px var(--font-ui);cursor:pointer}.undo:hover{border-color:var(--border-strong);color:var(--ink)}.settled{font-size:9px;color:var(--text-3);text-align:center}.empty{text-align:center;padding:80px 20px;border:1px dashed var(--border-strong);border-radius:12px}.empty>span{width:60px;height:60px;border-radius:50%;display:grid;place-items:center;margin:0 auto 16px;background:var(--surface-3);color:var(--text-3)}.empty h2{font:650 18px var(--font-display);margin:0}.empty p{font-size:11px;color:var(--text-3)}@media(max-width:650px){.history-toolbar>span{display:none}.history-toolbar label{width:100%}.history-list article{grid-template-columns:40px 1fr 68px}.result{display:none}}
</style>
